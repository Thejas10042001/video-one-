...
`;
  ...
  return (
    <div className="flex h-full bg-slate-950 relative overflow-hidden">
      ...
      <aside 
        id="tour-gpt-sidebar"
        className="w-80 border-r border-white/5 bg-neural-900/30 flex flex-col z-30"
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
          <div>
            ...
            <div className="space-y-2" id="tour-gpt-session-list">
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        ...
                        <div className="flex items-center gap-1 text-[8px] font-black uppercase bg-indigo-500/10 px-2 py-0.5 rounded text-indigo-400">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden h-full bg-slate-950">
        ...
        {/* Header */}
        <div id="gpt-header-core" className="w-full bg-slate-950/80 backdrop-blur-xl border-b border-slate-800 z-20">
          <div className="max-w-5xl mx-auto px-12 py-4 flex items-center justify-between">
            <div className="flex items-center gap-6">
               ...
               <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-indigo-600/10 border border-indigo-500/30 text-indigo-400 rounded-full text-[9px] font-black uppercase tracking-widest hover:bg-indigo-600/20 transition-all group"
               >
                  <ICONS.Info className="w-3 h-3 group-hover:rotate-12 transition-transform" />
